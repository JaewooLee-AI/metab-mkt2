...
function getSystemPrompt(channel: 'shorts' | 'blog' | 'cafe' | 'sales' | 'instagram', persona: PersonaType): string {
...
export async function handleGenerationLogic(body: any) {
  ...
  // Fallback: manually read local .env file
  if (!apiKey) {
    try {
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const result = await handleGenerationLogic(req.body);
